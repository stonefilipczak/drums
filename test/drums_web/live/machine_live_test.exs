defmodule DrumsWeb.MachineLiveTest do
  use DrumsWeb.ConnCase

  import Phoenix.LiveViewTest
  import Drums.MachinesFixtures

  @create_attrs %{name: "some name", state: %{}}
  @update_attrs %{name: "some updated name", state: %{}}
